  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.text_container}>
        <Text style={styles.ayomulai}>Create an new account</Text>
      </View>
      ...
      <View style={styles.form_container}>
        ...
        >
          <Text style={styles.text_mulai}>Sign Up</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.bottomtext_container}>
        <Text style={styles.text_style}>Have an account?</Text>
        <TouchableOpacity onPress={() => navigation.navigate("SignIn")}>
          <Text style={styles.text2_style}> Sign in</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
